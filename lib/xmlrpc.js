 ...
 * @param {number} [options.keepALive] keepAlive Miliseconds, 0 to disable (default).
 * @param {string} [options.gzip] GZip support, false default. could be 'response' or 'both'.
